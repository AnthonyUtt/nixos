{
  description = "A basic Flutter dev environment";
  ...
  outputs = inputs: with inputs;
    ...
    let
      ...
      androidComposition = androidEnv.composeAndroidPackages {
        ...
        systemImageTypes = [ "google_atd" "aosp_atd" ];
    ...
    in {
      devShell = with pkgs; mkShell rec {
        ...
        # NB: due to the emulator's bundled qt version, it currently does not
        # start with QT_QPA_PLATFORM="wayland". Maybe one day this will be supported.
